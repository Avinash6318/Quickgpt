    ...
    return (
        <div className=" ml-5 p-5">
            <form
                ...
                className="w-full sm:w-87.5 text-center m-auto mt-30 bg-black/6 border border-white/10 rounded-2xl px-8">
                ...
                {state !== "login" && (
                    <div className="flex items-center mt-6 w-full bg-white/5 ring-2 ring-black/10 focus-within:ring-indigo-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
